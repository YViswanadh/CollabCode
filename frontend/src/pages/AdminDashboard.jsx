    ...
    <div className={`min-h-screen flex flex-col font-sans transition-colors duration-300 animate-page-transition overflow-x-hidden relative ${
      ...
      <header className={`sticky top-0 z-40 w-full backdrop-blur-xl border-b px-6 py-4 flex items-center justify-between shadow-lg transition-all duration-300 ${
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/workspace"
            className="px-4 py-2 text-xs rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 text-white font-extrabold shadow-md shadow-cyan-500/20 active:scale-95 transition-all duration-150 cursor-pointer"
          >
            Workspace
          </Link>
        </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className={`p-6 border rounded-3xl shadow-md transition-all duration-300 ${
            theme === 'dark' ? 'bg-slate-900/20 border-slate-800/80' : 'bg-white border-slate-200 shadow-slate-100 shadow-lg'
          }`}>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-around gap-6">
                ...
                <div className="space-y-3 font-mono text-[11px] w-full sm:w-auto shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="flex-1 text-slate-400">Beginners:</span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="flex-1 text-slate-400">Intermediates:</span>
                    <strong className={theme === 'dark' ? 'text-slate-200' : 'text-slate-800'}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="flex-1 text-slate-400">Experts:</span>
                    <strong className={theme === 'dark' ? 'text-slate-200' : 'text-slate-800'}>
                ...
                {ratingDistribution.map((dist) => {
                  ...
                  return (
                    <div key={dist.stars} className="flex flex-col items-center gap-2 flex-1 w-full">
                      ...
                      <span className="text-[10px] font-mono font-bold text-slate-400">{dist.stars} ★</span>
                    </div>
                  );
                })}
              </div>
                ...
                {feedbacks.map((f) => (
                  <div
                    ...
                    className={`border rounded-3xl p-6 shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between ${
                      theme === 'dark'
                        ? 'bg-slate-900/10 border-slate-800/80 shadow-black/10 hover:bg-slate-900/20'
                        : 'bg-white border-slate-200/80 hover:border-slate-300 shadow-slate-100 shadow-md'
                    }`}
                  >
                    <div>
                      <div className="flex items-center justify-between pb-3 border-b border-slate-800/45 mb-4">
                        <div>
                    ...
                    <div className="flex items-center justify-between mt-6 pt-3 border-t border-slate-800/45">
                    ...
                    {users.map((u) => (
                      <tr
                        ...
                        className={`border-b transition-all duration-150 ${
                          theme === 'dark'
                            ? 'bg-slate-900/10 border-slate-800/60 hover:bg-slate-900/20'
